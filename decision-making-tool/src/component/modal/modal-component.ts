...
export default class ModalComponent {
  ...
  public addModal(): void {
    ...
    const textarea = new BaseComponent(form.node, 'textarea', 'textarea-content');

    textarea.setAttribute(
      'placeholder',
      'Paste your options here in CSV-like format:\nOption 1,10\nOption 2,20\nOption 3,30'
    );
    this.buttonCancel = new BaseComponent(form.node, 'button', 'button', 'Cancel');
    this.buttonConfirm = new BaseComponent(form.node, 'button', 'button', 'Confirm');
